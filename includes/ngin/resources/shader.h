...
public:
    ...
    Shader() {} 
    Shader(const std::string name, const Nevf& data) : name_(name) {
        headPath_ = data.getC<std::string>("header", "").c_str()
        vertPath_ = data.getC<std::string>("vertex", "").c_str()
        fragPath_ = data.getC<std::string>("fragment", "").c_str()
        geomPath_ = nullptr;
        if (data.contains("geometry")) {
            geomPath_ = data.getC<std::string>("geometry", "").c_str()
        }
        inclPath_ = nullptr;
        if (data.contains("include")) {
            inclPath_ = data.getC<std::string>("include", "").c_str()
        }
    }   
    ...
    void load() {
        ...
        unsigned int fragment = loadFrag();
        unsigned int vertex = loadVert();
        ...
        if(geomPath_ != nullptr) {
            unsigned int geometry = loadGeom();
