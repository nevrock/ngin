...
public:
    ...
    // ------------------------------------------------------------------------
    Shader() {}
    Shader(const char* vertexPath, const char* fragmentPath, const char* headerPath,
        const char* geometryPath = nullptr, const char* includePath = nullptr)
    {
